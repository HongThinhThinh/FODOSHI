...
import { bannerMalePage } from "../../../assets/contant";
...
function MalePage() {
  ...
  return (
    <>
      <section className="male-page-banner__container">
        <img className="male-page-banner__img" src={bannerMalePage} alt="" />
      </section>
      <section className="male-page__container">
        <Row className="male-page__wrapper">
          <Col className="male-page__aside" span={5}>
            <div className="male-page__aside__item rounded-full">
          ...
          <Col className="male-page__products" span={19}>
