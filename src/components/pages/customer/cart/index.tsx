...
import { add, changeQuantity, getAll, remove, reset } from "../../../../redux/features/cartSlice";
...
export default function Cart() {
  ...
  return (
    <div className="cart">
      <div className="cart__title">Your Cart ( {cart.products.length} items)</div>
        ...
        {cart.products.length === 0 ? (
          ...
          cart.products.map((product: Product) => (
            <div className="cart__items__item">
              ...
              <div className="cart__items__item__price">{formatMoney(product.price)}</div>
      ...
      <div className="cart__bills">
        ...
        <div className="cart__bills__right">
          <div className="cart__bills__right__item">
            <span className="cart__bills__right__item__title">Sub total : </span>
            <span>{formatMoney(total)}</span>
          </div>
          <div className="cart__bills__right__item">
            <span className="cart__bills__right__item__title">Sales Tax : </span>{" "}
            <span>{tax}%</span>
          </div>
          <div className="cart__bills__right__item">
            <span className="cart__bills__right__item__title">Coupon Code : </span>
            <span>
              <Link to={"/"}>Add Coupon</Link>
            </span>
          </div>
          <div id="grand-total" className="cart__bills__right__item">
            <span className="cart__bills__right__item__title">Grand total : </span>
